...
const getAllProductFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const prodctQuery = new QueryBuilder_1.default(product_schema_1.Product.find(), query)
...
const updateSingleProductFromDB = (data, _id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield product_schema_1.Product.findByIdAndUpdate({ _id }, modifiedData, {
        new: true,
    });
    return result;
});
const deleteSingleProductFromDB = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield product_schema_1.Product.findById(_id);
    if (!isExist) {
        throw new AppError_1.default(404, "Item Not Found to Delete");
    }
    const result = yield product_schema_1.Product.findByIdAndDelete(_id);
    return result;
});
const getAllCategoryFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_schema_1.Product.find();
    return result;
});
